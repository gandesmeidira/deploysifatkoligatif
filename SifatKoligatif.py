...
if selected == 'Halaman Utama':
    ...
    with tab1:
        ...
        image_bytes = open(r'D:\webapps_using_streamlit\sifatkoligatif.jpg', 'rb').read()
    ...
    with tab2:
        ...
        image_bytes = open(r'D:\webapps_using_streamlit\TekananUap.jpg', 'rb').read()
        st.image(image_bytes, use_column_width=True)
    with tab3:
        ...
        image_bytes = open(r'D:\webapps_using_streamlit\TitikBeku.jpg', 'rb').read()
        st.image(image_bytes, use_column_width=True)
    with tab4:
        ...
        image_bytes = open(r'D:\webapps_using_streamlit\TitikDidih.jpg', 'rb').read()
        st.image(image_bytes, use_column_width=True)
    with tab5:
        ...
        image_bytes = open(r'D:\webapps_using_streamlit\osmosis.jpg', 'rb').read()
        st.image(image_bytes, use_column_width=True)
